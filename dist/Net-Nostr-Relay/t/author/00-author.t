...
my $dist        = 'Net-Nostr-Relay';
my $main_module = 'lib/Net/Nostr/Relay.pm';
...
subtest 'top-level module POD links related distributions' => sub {
    my $source = _slurp($main_module);
    like($source, qr/L<Net::Nostr>/, 'Relay POD links to Net::Nostr');
    like($source, qr/L<Net::Nostr::Core>/, 'Relay POD links to Net::Nostr::Core');
    like($source, qr/L<Net::Nostr::Client>/, 'Relay POD links to Net::Nostr::Client');
};
